...
public class AbstractChangeLanguageWindow extends JFrame implements ChangeLanguageWindow
{
	...
	/**
	 * Cria JRadioButtonMenuItem configurando LanguageTool e setando com o valor correspondente ao do idioma selecionado.
	 * @param key
	 * @param defaultLabel
	 * @return
	 */
	public JRadioButtonMenuItem createJRadioButtonMenuItem(String key, String defaultLabel){
		return WindowUtil.createJRadioButtonMenuItem(key, defaultLabel, this.refreshLabelSet);
	}

...
public class WindowUtil
{
	...
	public static void refreshLabel(AbstractButton item)
	{
		...
		String toolTipTextKey = key+".tooltiptext";
		String toolTipText = LanguageTool.getString(toolTipTextKey, item.getToolTipText());
	...
	/**
	 * Cria JRadioMenuItem configurando LanguageTool e setando com o valor correspondente ao do idioma selecionado.
	 * @param key
	 * @param defaultLabel
	 * @param refreshLabelSet
	 * @return
	 */
	public static JRadioButtonMenuItem createJRadioButtonMenuItem(String key, String defaultLabel, Set<Object> refreshLabelSet) 
	{
		LanguageTool.addString(key, defaultLabel);
		JRadioButtonMenuItem radioMenuItem = new JRadioButtonMenuItem(LanguageTool.getString(key));
		radioMenuItem.setName(key);
		refreshLabelSet.add(radioMenuItem);
